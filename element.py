...
"""
def check_possibility(octave1, octave2,letter1, letter2, note1,note2):
    interval_number = calculate_interval(octave1, octave2,note_letters.index(letter1[0]), note_letters.index(letter2[0]))
    ...
    if key in JUMP_CHART:
        ...
        ans = f"{e_ans} {no_ans}"
        print(note1,note2, ans)
        return ans, note1, note2,e_ans,no_ans
    else:
        ans = ''
        return ans
"""
